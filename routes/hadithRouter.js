...
const {validateHadith, reviewValidation,imageValidation} = require("../utilities/joi.js");
...
router.route('/')
.get(wrapAsync(theHadith.index))
.post(  isAuthenticated,  upload.array('image'),validateHadith,imageValidation,   wrapAsync(theHadith.postNewForm)  );
...
.patch( isAuthenticated,isAuthorized, upload.array('image'),validateHadith, wrapAsync(theHadith.postEditForm))
